...
public static Street[] createStreets(Place[] _places){
	...
	public static void main(String[] args) {
		 ...
		 */
		Place[] ciudad = new Place[10];
		ciudad = Main.createPlaces();
		Street[] Madrid = new Street[11];
		Madrid = Main.createStreets(ciudad);
		RobotEngine walle = new RobotEngine(ciudad[0], Direction.NORTH, Madrid);
		walle.startEngine();
